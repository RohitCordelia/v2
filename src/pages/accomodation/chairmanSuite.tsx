...
const Amenities = [
    ...
    },
    {
        ...
        content: 'Master bedroom with a splendid view'
    },
    {
        icon: 'https://images.cordeliacruises.com/cordelia_v2/public/assets/bathroom-icon.svg',
        content: 'Walk-in closet with a vanity area'
    },
    {
        icon: 'https://images.cordeliacruises.com/cordelia_v2/public/assets/barcounter-icon.svg',
        content: 'Stylish bar counter'
    },
    {
        icon: 'https://images.cordeliacruises.com/cordelia_v2/public/assets/dining-icon.svg',
        content: 'Dining area with a six-seater table '
    },
    {
        icon: 'https://images.cordeliacruises.com/cordelia_v2/public/assets/jacuzzi-icon.svg',
        content: 'Jacuzzi '
    },
    {
        icon: 'https://images.cordeliacruises.com/cordelia_v2/public/assets/tv-icon.svg',
        content: 'TVs in the living room and bedroom'
    },
    {
    ...
    {
        icon: 'https://images.cordeliacruises.com/cordelia_v2/public/assets/minibar-icon.svg',
        content: 'Mini-bar on request (chargeable)'
    },
]
...
export default function ChairmanSuite({
    className = ''
}: Props) {
    return (
        <div className={`${className}`}>
            <div className='relative rounded-lg border border-gray-300/40 shadow-md'>
                <div>
                    ...
                    >
                        <div>
                            <img className='w-full' src="https://images.cordeliacruises.com/cordelia_v2/public/images/chairmansuite-room-1.webp" />
                        </div>
                        <div>
                            <img className='w-full' src="https://images.cordeliacruises.com/cordelia_v2/public/images/chairmansuite-room-2.webp" />
                        </div>
                        <div>
                            <img className='w-full' src="https://images.cordeliacruises.com/cordelia_v2/public/images/chairmansuite-room-3.webp" />
                        </div>
                    </Glider>
                </div>
                <div className='py-8 px-6'>
                    <h1 className='text-xl lg:text-3xl font-semibold'>The Chairman's Suite</h1>
                    <p className='text-sm lg:text-lg font-medium mt-3 lg:mt-6 !leading-6 lg:!leading-8'>
                        The Chairman’s Suite has a luxe living room, a private dining area with a six-seater dining table, a stylish bar counter, a majestic master bedroom, a fantastic walk-in closet, a private sun-deck balcony, Jacuzzi and a feeling that’s second to none.
                    </p>
