...
export default function InteriorStateroom({
    className = ''
}: Props) {
    return (
        <div className={`${className}`}>
            <div className='relative rounded-lg border border-gray-300/40 shadow-md'>
                <div>
                    ...
                    >
                        <div>
                            <img className='w-full' src="https://images.cordeliacruises.com/cordelia_v2/public/images/interior-room-1.webp" />
                        </div>
                        <div>
                            <img className='w-full' src="https://images.cordeliacruises.com/cordelia_v2/public/images/interior-room-2.webp" />
                        </div>
                        <div>
                            <img className='w-full' src="https://images.cordeliacruises.com/cordelia_v2/public/images/interior-room-3.webp" />
                        </div>
                    </Glider>
                </div>
                <div className='py-8 px-6'>
                    <h1 className='text-xl lg:text-3xl font-semibold'>Interior Stateroom</h1>
                    <p className='text-sm lg:text-lg font-medium mt-3 lg:mt-6 !leading-6 lg:!leading-8'>
                        Not only are they budget-friendly, our interior staterooms have everything you need to make your journey and stay onboard truly special.
                    </p>
                    {/* <div className='border-t-2 my-5 border-gray-300 lg:mt-16' /> */}
