...
const banner = {
  ...
  "images": [
    {
      "url": "http://images.cordeliacruises.com/cordelia_v2/public/images/cordelia-visakhapatnam-banner-desktop.webp",
      "link": "",
      "altTag": "visakhapatnam",
      "type": "image",
      "thumbnail": ""
    },
  ],
  "mobileImages": [
    {
      "url": "https://images.cordeliacruises.com/cordelia_v2/public/images/cordelia-visakhapatnam-banner-mobile.webp",
      "link": "",
      "altTag": "visakhapatnam",
      "type": "image",
      "thumbnail": ""
...
const Info_vizag = {
  "info_section": {
    ...
    "sub_title": "Embark on a journey like no other with Cordelia Cruises. Enjoy premium amenities on board as you take unforgettable excursions to the stunning shores of Vizag."
  },
  "info_cards": [
    {
      "link": "food-beverage",
    ...
    },
    {
      ...
      "sub_title": "Relax and unwind as you sail to Vizag. The Empress and its crew will provide you with exceptional hospitality throughout your journey."
    },
    {
      "link": "destination",
...
export default function Home(props: Props) {
  ...
  useMetaTags({
    title: 'Visakhapatnam Cruise Packages | Book Visakhapatnam cruise packages with Cordelia Cruises',
    description: 'Cruise to Visakhapatnam with Cordelia. Indulge in gourmet cuisine, relaxing stays, entertainment & unforgettable moments onboard.',
    metas: [
      {
        name: 'keywords',
        content:
          'Visakhapatnam cruise packages, cruise packages from Visakhapatnam, cruise packages, cruise, cordelia cruises, cruise packages price in india, best cruise packages, weekend cruises, cruise to Visakhapatnam'
      },
    ],
  })
  ...
  const data = {
    "title": "Discover Visakhapatnam with Cordelia Cruises",
    "vidUrl": "https://vimeo.com/891436784",
    "subTitle": "Experience the azure waters of the Bay of Bengal and explore the vibrant culture of Visakhapatnam, a city where natural beauty meets rich cultural heritage. Nestled along the eastern coast of India, Visakhapatnam, affectionately known as Vizag, offers pristine beaches, lush hills, and historic landmarks.",
  ...
  return (
    <Layout>
      <main>
        ...
        {CONTENT[EVENT][PERSONA].template === 1 ? (
          <>
            ...
            <section>
              {<Suspense fallback={<div>Loading.....</div>}>
                <InfoSection content={Info_vizag.info_cards} info_section={Info_vizag.info_section} />
              </Suspense>}
            </section>
          </>
        ) : (
      ...
      <div className='fixed w-full bottom-0 z-30 lg:hidden'>
        <div className=''>
          <div className='mt-3'>
            <Button text="Book Now" handleClick={() => navigate('/upcoming-cruises?port=Visakhapatnam')} className="w-full rounded-none" />
          </div>
        </div>
      </div>
