...
const banner = {
  ...
  "images": [
    {
      "url": "https://images.cordeliacruises.com/cordelia_v2/public/images/cordelia-puducherry-banner-desktop.webp",
      "link": "",
      "altTag": "Puducherry",
      "type": "image",
      "thumbnail": ""
  ...
  "mobileImages": [
    {
      "url": "http://images.cordeliacruises.com/cordelia_v2/public/images/cordelia-puducherry-banner-mobile.webp",
      "link": "",
      "altTag": "Puducherry",
      "type": "image",
      "thumbnail": ""
...
const Info_pond = {
  "info_section": {
    ...
    "sub_title": "Embark on a journey like no other with Cordelia Cruises. Enjoy premium amenities on board as you take unforgettable excursions to the stunning shores of Puducherry."
  },
  "info_cards": [
    {
      "link": "food-beverage",
...
export default function Home(props: Props) {
  ...
  useMetaTags({
    title: 'Pondichery Cruise Packages | Book Pondichery cruise packages with Cordelia Cruises',
    description: 'Cruise to Pondichery with Cordelia. Indulge in gourmet cuisine, relaxing stays, entertainment & unforgettable moments onboard.',
    metas: [
      {
        name: 'keywords',
        content:
          'Pondichery cruise packages, cruise packages from Pondichery, cruise packages, cruise, cordelia cruises, cruise packages price in india, best cruise packages, weekend cruises, cruise to Pondichery'
      },
    ],
  })
  ...
  const data = {
    "title": "Explore Puducherry with Cordelia Cruises",
    "vidUrl": "https://vimeo.com/891436784",
    "subTitle": "Set sail with Cordelia Cruises to Puducherry, a charming coastal town where French colonial heritage blends seamlessly with Indian culture. Known for its serene beaches, vibrant streets, and spiritual retreats, Puducherry offers a unique and enriching experience for every traveller.",
  ...
  return (
    <Layout>
      ...
      <div className='fixed w-full bottom-0 z-30 lg:hidden'>
        <div className=''>
          <div className='mt-3'>
            <Button text="Book Now" handleClick={() => navigate('/upcoming-cruises?port=Puducherry')} className="w-full rounded-none" />
          </div>
        </div>
      </div>
