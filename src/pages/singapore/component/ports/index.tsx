...
const PortDetail = [
    ...
    //     shoreEx: [],
    //     mapLink: "chennai-landing",
    //     landingKey: "Chennai_Landing"
    // },
    {
        name: "Phuket, Thailand",
        link: 'Phuket',
        mapLink: "/thailand/phuket",
        page_code:"PHK",
        landingKey: "thailand/phuket",
        upComingCode:"PHUKET",
    ...
    },
    {
        ...
        page_code:"LAN",
        landingKey: "Langkawi_Landing",
        upComingCode:"LANGKAWI",
    ...
    },
    {
        ...
        page_code:"KLUM",
        landingKey: "KualaLumpur_Landing",
        upComingCode:"KUALA LUMPUR",
...
export default function Ports(props: Props) {
    ...
    return (
        <div className='container mx-auto lg:mb-10 mb-6 px-4 lg:px-0'>
                                ...
                                <div className="py-3 flex">
                                    <Button
                                        ...
                                        handleClick={() =>
                                            navigate(v.mapLink, {
                                                state: {
                                                    pageCode: v.page_code,
                                                    upcomingCode: v?.upComingCode,
                                                    link: v.link
                                                }
                                            })
                                        }
            ...
            {/* <div className="lg:flex justify-center mt-8 hidden">
                <a href={`/upcoming-cruises?port=Singapore`} className="bg-brand-primary px-6 py-2.5 text-white rounded" >Book Now</a>
            </div> */}
            <div className="block lg:hidden">
                {PortDetailMobile.map((v: any, i: any) =>
                    <div className="mb-8 shadow-allSide px-4 lg:px-8 py-4 lg:py-8 rounded" id={v.name}>
                        <div className="grid grid-cols-5 gap-4 lg:gap-6 items-center mb-0 lg:mb-10">
                            <div className="col-span-5 lg:col-span-2">
                                <img className="h-[190px] lg:h-full w-full" src={v.image} alt="" />
                            </div>
                            <div className="col-span-5 lg:col-span-3">
                                ...
                                <p className="text-xxs lg:text-[17px] font-extralight leading-5 lg:leading-8 mt-2 lg:mt-4">{v.desc}</p>
                                <div className="py-3 flex">
                                    <a className='lg:text-lg text-base flex gap-2 items-center font-bold border-2 border-brand-primary py-3 px-4 rounded text-white bg-brand-primary' onClick={() => navigate(v.mapLink, { state: { pageCode: v.page_code, upcomingCode: v?.upComingCode, link:v.link } })}>
                                        <span>
                                            <img src="https://images.cordeliacruises.com/cordelia_v2/public/assets/directions-icon.svg" />
                                        </span>
                                        Read More
