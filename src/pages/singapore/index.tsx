...
const banner = {
  ...
  "images": [
    ...
    // },
    {
      "url": "https://cordelia-images-prod.s3.ap-south-1.amazonaws.com/cordelia_v2/public/images/SAMIS_4000x1667.webp",
      "link": "#",
      "altTag": "",
      "type": "image",
      "thumbnail": ""
    ...
    {
      "url": "https://images.cordeliacruises.com/cordelia_v2/public/images/SEA_DESKTOP_DESTINATION.webp",
      "link": "#",
      "altTag": "",
      "type": "image",
      "thumbnail": ""
  ...
  "mobileImages": [
    ...
    // },
    {
      "url": "https://images.cordeliacruises.com/cordelia_v2/public/images/SAMIS_2342x2309.webp",
      "link": "#",
      "altTag": "",
      "type": "image",
      "thumbnail": ""
    ...
    {
      "url": "https://images.cordeliacruises.com/cordelia_v2/public/images/SEA_MOBILE_DESTINATION.webp",
      "link": "#",
      "altTag": "",
      "type": "image",
      "thumbnail": ""
  ...
  const offers = [
    ...
    },
    {
      ...
      description: [
        ...
        "Applicable sailing dates: 19th July.",
        "This offer cannot be combined with any other existing promotions.",
      ]
    },
    {
    ...
    <>
      <Layout>
        <main>
          ...
          <section className="my-8 lg:my-14">
            {<Suspense fallback={<div>Loading.....</div>}>
              <UpcomingCruise template={CONTENT[EVENT][PERSONA].template} port_codes={port_codes} page="south-east-asia" />
            </Suspense>}
          </section>
          <section>
            <Ports />
        ...
        <div className='fixed w-full bottom-0 z-30 lg:hidden'>
          <div className=''>
            <div className='mt-3'>
              <Button text="Book Now" size="sm" handleClick={() => navigate('/upcoming-cruises?port=Singapore')} className="w-full rounded-none" />
            </div>
          </div>
        </div>
