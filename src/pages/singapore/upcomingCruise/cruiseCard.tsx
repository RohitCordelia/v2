...
export default function CruiseCard({
    ...
    return (
        <section>
            <div className="bg-white mb-2 shadow-md border border-gray-300 rounded grid lg:grid-cols-11 grid-cols-12 cursor-pointer overflow-hidden" onClick={() => navigate(`/upcoming-cruises?itinerary_id=${itinerary_id}`)}>
                <div className='col-span-2 w-full lg:inline-block hidden'>
                    <img
                        src={"https://images.cordeliacruises.com/cordelia_v2/public/images/singapore-landing-port-image.webp" || image_url}
