...
const Info_pond = {
  "info_section": {
    ...
    "sub_title": "Embark on a journey like no other with Cordelia Cruises. Enjoy premium amenities on board as you take unforgettable excursions to the stunning shores of Pondicherry."
  },
  "info_cards": [
    {
      "link": "food-beverage",
    ...
    <>
      ...
      <main>
        <section className="">
          ...
          <LeadGenForm page_code='pondicherry' />
        </section>
        <section>
