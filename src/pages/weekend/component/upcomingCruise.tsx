                                ...
                                <div className='mx-2 rounded-lg shadow-md'>
                                    ...
                                    <div className='py-3 lg:py-6 bg-white text-center'>
                                        ...
                                        <div className='flex justify-between items-center px-4'>
                                           ...
                                           <a href={`/select-itinerary?n=2,3&rt=true&itinerary=${val.itinerary_id}`} className="cursor-pointer rounded bg-brand-primary font-outfit text-white py-2 lg:py-3.5 font-semibold lg:text-lg px-5 lg:px-10">Book Now</a>
                                            </div>
                                    </div>
                                </div>
                            </div>
