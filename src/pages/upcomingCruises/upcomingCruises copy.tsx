...
export default function UpcomingCruises({ }: Props) {
  ...
  const onSubmitOTP = (data: any) => {
    ...
    const _payload = { phone_number: data.phone_number };
    sendOTP(_payload)
      .unwrap()
      .then((response) => {
        setShowOTP(true)
  ...
  const onVerifyOTP = () => {
    const _payload = { phone_number: phoneNumber, otp: otp, website: currentUrl };
    ...
    <Layout>
      <main className="container mx-auto py-24 lg:pt-36">
        <div className=" px-3">
          ...
          {/* Calender section */}
          <div className="overflow-hidden overflow-x-scroll pb-4 w-full" draggable="true">
        ...
        <div className='grid lg:grid-cols-2'>
          <div className="mx-4 pt-3">
            <ul>
              <h1 className='font-semibold mb-2 lg:text-xl lg:mb-3'>Itinerary</h1>
              {!selectedItinerary ? (
                <TimeLineLoader />
              ) : (
            ...
            {selectedItinerary?.itinerary_id == '86025f26-e82e-4906-b1c0-424765cb785e' ?
              ...
              :
              <div className='px-4'>
                <h1 className="font-semibold lg:text-2xl lg:mt-4">
                  Onboard Offerings
                </h1>
                ...
                <a href="https://cordelia-images-prod.s3.ap-south-1.amazonaws.com/static/Inclusions+%26+Exclusions.pdf" target="_blank">
