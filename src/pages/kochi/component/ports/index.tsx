...
const PortDetail = [
    {
        ...
        port: "Kochi",
        mapLink: "https://maps.app.goo.gl/2mDTUpHeem1srCXv7",
        shoreEx: [
            {
                    ...
                    <div className="mb-8 shadow-allSide px-4 lg:px-8 py-4 lg:py-8 rounded" id={v.name}>
                        <div className="grid grid-cols-5 gap-4 lg:gap-6 items-center mb-6 lg:mb-10">
                            ...
                            <div className="col-span-5 lg:col-span-3">
                                ...
                                {/* <a href='https://maps.app.goo.gl/2mDTUpHeem1srCXv7' target='_blank' className='w-full min-h-[60px] lg:min-h-[95px] grid grid-cols-11 mt-6 rounded-b-md'>
                                    <img className='lg:h-6 bg-brand-primary' src="https://images.cordeliacruises.com/cordelia_v2/public/assets/directions-icon.svg" />
                                    <p  className='lg:text-xl text-base text-brand-primary font-bold underline'>Directions</p>
                                </a> */}
                            </div>
                        </div>
