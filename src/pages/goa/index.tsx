...
const banner = {
  ...
  "images": [
    {
      "url": "https://images.cordeliacruises.com/cordelia_v2/public/images/Goa_desktop_16.webp",
      "link": "/upcoming-cruises?port=Goa",
      "altTag": "",
      "type": "image",
      "thumbnail": ""
    },
  ...
  "mobileImages": [
    {
      "url": "https://images.cordeliacruises.com/cordelia_v2/public/images/Goa_mobile_16.webp",
      "link": "/upcoming-cruises?port=Goa",
      "altTag": "",
      "type": "image",
      "thumbnail": ""
...
const Info_Goa = {
  "info_section": {
    ...
    "sub_title": "Embark on a journey like no other with Cordelia Cruises. Enjoy premium amenities on board as you take unforgettable excursions to the stunning shores of Goa."
  },
  "info_cards": [
    {
      "link": "food-beverage",
    ...
    },
    {
      ...
      "sub_title": "Relax and unwind as you sail to Goa. The Empress and its crew will provide you with exceptional hospitality throughout your journey."
    },
    {
      "link": "destination",
...
const portCode = "pagination=false\u0026port_codes=MRM"

export default function Home(props: Props) {
  let navigate = useNavigate()
  const [description, setDescription] = useState<any>(false);
  useMetaTags({
    title: 'Goa Cruise Packages | Book Goa cruise packages with Cordelia Cruises',
    description: 'Cruise to Goa with Cordelia. Indulge in gourmet cuisine, relaxing stays, entertainment & unforgettable moments onboard.',
    metas: [
      {
        name: 'keywords',
        content:
          'Goa cruise packages, cruise packages from goa, cruise packages, cruise, cordelia cruises, cruise packages price in india, best cruise packages, weekend cruises'
      },
    ],
  })
  ...
  const data = {
    "title": "EXPLORE INDIA’S FAVOURITE HOLIDAY DESTINATION ON OUR GOA CRUISE",
    "vidUrl": "https://www.youtube.com/watch?v=PR6OjCvhcPE",
    "subTitle": "Arrive in Goa in style aboard the Empress and let its vibrant energy wash over you. Dive into action-packed water sports or unwind on tranquil stretches of golden sand. Explore the rich Portuguese heritage in charming villages or lose yourself in bustling night markets overflowing with local treasures. Goa's culinary scene will tantalize your taste buds - fiery curries, fresh seafood, and more await.",
    "vidThumbnail": "https://images.cordeliacruises.com/cordelia_v2/public/images/GOA_video_thumbnail.webp"
  }
  ...
  return (
    <Layout>
      <main>
              ...
              {offers.map((val, index) => (
                <div className="flex justify-between shadow-allSide" key={index}>
                  ...
                  {/* <div className="bg-brand-primary px-2 lg:px-4 py-3 lg:py-4 rounded-r">
                    <p className='lg:text-sm text-xxs font-bold text-white cursor-pointer whitespace-nowrap' onClick={() => navigate('/upcoming-cruises?destinationPorts=goa')}>Find Cruise</p>
                  </div> */}
                  <Button text='Find Cruise' size="sm" handleClick={() => navigate('/upcoming-cruises?destinationPorts=Goa')} className="rounded-l-none whitespace-nowrap" />
                </div>
              ))}
            </div>
          </div>
        ...
        {CONTENT[EVENT][PERSONA].template === 1 ? (
          <>
            ...
            <section>
              {<Suspense fallback={<div>Loading.....</div>}>
                <InfoSection content={Info_Goa.info_cards} info_section={Info_Goa.info_section} />
              </Suspense>}
            </section>
          </>
        ) : (
      ...
      <div className='fixed w-full bottom-0 z-30 lg:hidden'>
        <div className=''>
          <div className='mt-3'>
            <Button text="Book Now" handleClick={() => navigate('/upcoming-cruises?port=Goa')} className="w-full rounded-none" />
          </div>
        </div>
      </div>
