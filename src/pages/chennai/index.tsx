...
const banner = {
  ...
  "images": [
    {
      "url": "http://images.cordeliacruises.com/cordelia_v2/public/images/chennai-main-banner-new-desktop-march-08.webp",
      "link": "",
      "altTag": "Chennai",
      "type": "image",
      "thumbnail": ""
  ...
  "mobileImages": [
    {
      "url": "https://images.cordeliacruises.com/cordelia_v2/public/images/chennai-main-banner-new-mobile-march-08.webp",
      "link": "",
      "altTag": "Chennai",
      "type": "image",
      "thumbnail": ""
...
const Info_pond = {
  "info_section": {
    ...
    "sub_title": "Embark on a journey like no other with Cordelia Cruises. Enjoy premium amenities on board as you take unforgettable excursions to the stunning shores of Chennai."
  },
  "info_cards": [
    {
      "link": "food-beverage",
    ...
    },
    {
      ...
      "sub_title": "Relax and unwind as you sail to Puducherry. The Empress and its crew will provide you with exceptional hospitality throughout your journey."
    },
    {
      "link": "destination",
...
export default function Home(props: Props) {
  ...
  useMetaTags({
    title: 'Chennai Cruise Packages | Book Chennai cruise packages with Cordelia Cruises',
    description: 'Cruise to Chennai with Cordelia. Indulge in gourmet cuisine, relaxing stays, entertainment & unforgettable moments onboard.',
    metas: [
      {
        name: 'keywords',
        content:
          'Chennai cruise packages, cruise packages from Chennai, cruise packages, cruise, cordelia cruises, cruise packages price in india, best cruise packages, weekend cruises, cruise to chennai'
      },
    ],
  })
  ...
  const data = {
    "title": "The Gateway to Your East Coast Adventure",
    "vidUrl": "https://vimeo.com/891436784",
    "subTitle": "Chennai, the vibrant coastal city, serves as the home port for Cordelia Cruises’ East Coast sailings. A perfect blend of history, culture, and scenic beauty, this bustling metropolis is your starting point for unforgettable journeys across the Bay of Bengal. Set sail from Chennai and explore breathtaking destinations while enjoying world-class hospitality on India’s premium cruise line.",
  ...
  return (
    <Layout>
      <main>
        ...
        {CONTENT[EVENT][PERSONA].template === 1 ? (
          <>
            ...
            <section>
              {<Suspense fallback={<div>Loading.....</div>}>
                <InfoSection content={Info_pond.info_cards} info_section={Info_pond.info_section} />
              </Suspense>}
            </section>
          </>
        ) : (
      ...
      <div className='fixed w-full bottom-0 z-30 lg:hidden'>
        <div className=''>
          <div className='mt-3'>
            <Button text="Book Now" handleClick={() => navigate('/upcoming-cruises?destinationPort=jaffna,hambantota,trincomalee')} className="w-full rounded-none" />
          </div>
        </div>
      </div>
