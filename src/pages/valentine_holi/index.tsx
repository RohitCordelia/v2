...
export default function Home(props: Props) {
    ...
    const banner = {
        "images": [
            {
                "url": "https://images.cordeliacruises.com/cordelia_v2/public/images/cordelia-valentine%2725-event-new-banner-desktop.webp",
                "link": "#",
                "altTag": "valentine"
            },
            {
        ...
        "mobileImages": [
            {
                "url": "https://images.cordeliacruises.com/cordelia_v2/public/images/cordelia-valentine%2725-event-new-banner-mobile.webp",
                "link": "#",
                "altTag": "valentine"
            },
            {
                        ...
                        <div className="mt-6 flex flex-wrap justify-center">
                            <div className="px-1 mb-2">
                                <button
                                    onClick={() => {
                                        setEvents('valentine')
                                        document.getElementById('valentine')?.scrollIntoView({
                                            behavior: 'smooth',
                                            block: 'start',
                                            inline: 'start',
                                        })
                                    }}
                                    className={`${events == 'valentine' ? 'text-white bg-brand-primary' : 'text-brand-primary'} border-2 border-brand-primary px-5 py-2.5 rounded-lg font-semibold`}
                                >
                                    Valentine
                                </button>
                            </div>
                            <div className="px-1 mb-2">
                                <button
                                    onClick={() => {
                                        setEvents('holi')
                                        document.getElementById('holi')?.scrollIntoView({
                                            behavior: 'smooth',
                                            block: 'start',
                                            inline: 'start',
                                        })
                                    }}
                                    className={`${events == 'holi' ? 'text-white bg-brand-primary' : 'text-brand-primary'} border-2 border-brand-primary px-5 py-2.5 rounded-lg font-semibold`}
                                >
                                    Holi
                                </button>
                            </div>
