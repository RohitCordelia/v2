...
import { GetManageDetail, GetStore, SaveManageDetail, SaveAuth, GetAuth, SaveStore } from '../../utils/store/store';
import './index.css'
                    ...
                    {itineraryData?.ship?.code?.toLowerCase() === "empress" && <div className="grid grid-cols-10 mb-4 gap-4 mt-5 rounded-sm">
                        <div className="col-span-10 lg:col-span-5  lg:py-6 py-4  shadow-allSide rounded-md">
                            ...
                            <div className="flex flex-wrap gap-2 items-end">
                                <a target='_blank' href=" https://images.cordeliacruises.com/cordelia_v2/public/pdf/empress-inclusion-exclusion-new-march-2025.pdf" className="text-brand-blue-2 font-semibold ml-6 mt-5 text-sm lg:text-lg underline ">{`View Inclusions & Exclusions`}</a>
                        ...
                        <div className=''>
                            {action === 'reschedule' ? (
                                ...
                                <Button
                                    text="View Cabins"
                                    size="sm"
                                    handleClick={() => window.open('/upcoming-cruises/selectCabin?id=' + itineraryId, '_blank')}
                                    btnStyle={{
                                        textWrap: 'nowrap'
                                    }}
                                />
